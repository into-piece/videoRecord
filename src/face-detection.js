...
class FaceDetection {
  constructor(options) {
    ...
    this.mediaRecorder = null; // 视频流录制类
    ...
    this.stopRecordBtn = document.querySelector(".stopRecordBtn");
    this.time = null; // 录制计时器
    this.timerEl = document.querySelector(".timer"); //计时显示
